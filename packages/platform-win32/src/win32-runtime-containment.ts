...
import {
  ...
  assertWin32ProcessController,
  type Win32ProcessController,
} from "./win32-services.js";

/**
 * Windows containment port for runtime processes (P0).
 *
 ...
 */
export class Win32RuntimeContainment implements RuntimeContainmentPort {
  readonly #controller: Win32ProcessController;
  readonly #tracked = new Set<RuntimeProcessHandle>();

  constructor(controller: Win32ProcessController) {
    assertWin32ProcessController(controller);
