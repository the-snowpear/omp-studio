import type { AgentId, Generation, JobId } from "./ids.js";
...
export type EvaluationOperation =
  ...
  | { kind: "eval.completion.start"; prompt: string; model?: "smol" | "default" | "slow"; system?: string; schema?: Record<string, unknown> }
