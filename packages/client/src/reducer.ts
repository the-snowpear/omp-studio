...
const SENSITIVE_COMMANDS: Readonly<Record<CommandName, boolean>> = {
  "skillshare.status": false,
  "skillshare.home": false,
  "skillshare.search": false,
  "skillshare.package": false,
  "skillshare.installed": false,
  "skillshare.tokens": false,
  "skillshare.prepare": true,
  "skillshare.execute": true,
  "skillshare.action": false,
  "skillshare.discard": true,
  "live.audio.prepare": true,
  "live.audio.start": true,
  "live.audio.status": false,
  "live.audio.mute": true,
  "live.audio.release": true,
  "media.models": false,
  "media.list": false,
  "media.read": false,
  "media.start": true,
  ...
  "media.resume": true,
  "media.close": true,
  "benchmarks.list": false,
  "benchmarks.read": false,
  "benchmarks.start": true,
  "benchmarks.cancel": true,
  "benchmarks.close": true,
  "templates.list": false,
  "templates.get": false,
  "templates.prepare": false,
  "mcp.runtime.status": false,
  "judgments.list": false,
  "judgments.create": true,
  "judgments.read": false,
  "judgments.cancel": true,
  "judgments.close": true,
  "judgments.retry": true,
  "artifacts.delete": true,
  "artifacts.saveText": true,
  "core.prompt": true,
  "core.steer": true,
  "core.followUp": true,
  "core.abort": true,
  ...
  "annotations.capture": false,
  "annotations.prepare": false,
  "services.list": false,
  "services.start": true,
  "services.stop": true,
  "services.restart": true,
  "services.mode.set": true,
  "services.send": true,
  "services.logs": false,
  "tokens.count": false,
  "runtime.models.list": false,
