...
> **Historical.** Draft from 2026-08-12. Current architecture:
> [`docs/architecture.md`](../docs/architecture.md). Feature map:
> [`feature-index.md`](feature-index.md). Changelog: [`CHANGELOG.md`](../CHANGELOG.md).
>
> 状态：实施基线草案
>
